...
@ScipyBackend.register_operator(CartesianGrid, "gradient", rank_in=0, rank_out=1)
def make_gradient(
    grid: CartesianGrid,
    *,
...
@ScipyBackend.register_operator(CartesianGrid, "divergence", rank_in=1, rank_out=0)
def make_divergence(
    grid: CartesianGrid,
    *,
    method: Literal["central", "forward", "backward"] = "central",
...
@ScipyBackend.register_operator(CartesianGrid, "vector_gradient", rank_in=1, rank_out=2)
