...
How many components need to be specified of the ghost cell? The answer depends on the operator that will be applied to the field: All components need to be specified if the vector field is to be interpolated, while only the normal components are specified for differential operators.
