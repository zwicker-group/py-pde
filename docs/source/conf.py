...
# Package-level re-exports intentionally create duplicate Python targets for the
# same public classes; suppress the corresponding ref.python warnings without
# hiding unrelated documentation errors.
